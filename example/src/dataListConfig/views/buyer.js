...
import versionFilters from '../filterGroups/version-filters';
...
export default {
    ...
    showTabsHeader :false,// filter view header
    showTabs :false,
    showListHeader : false,// List items header
     ...
     */
    filterGroups:[versionContentType, versionMetadata, versionRightsType, versionFilters],
     ...
     */
    link:{
        row:item=>`${config.itemLinkBaseUrl}/offer/${item.externalId}`,
        target:''//use '' or '_blank'
    },

    usersSavedFiltersets : ()=>new Promise((resolve,reject)=>{
        resolve(['filterset1','filterset2','filterset3']); 
    }),//returns a promise .
