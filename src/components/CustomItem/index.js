...
class CustomItem extends Component {
    ...
    makeCustomItem(item,selectedView,CustomDisplayItem, props,parentProps){
        ...
        return (<div className="dl__customItemInner">
                    {check}
                    <CustomDisplayItem item={item} selectedView={selectedView} parentProps={parentProps}/>
                </div>);
    }

    render() {
        const {item,selectedView,CustomDisplayItem,parentProps} = this.props;
