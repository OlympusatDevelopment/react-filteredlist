    ...
    _createClass(DataList, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                width = _props.width,
                listItems = showLoading || !Items ? selectedView.customContentPlaceholder ? this.makeContentPlaceholderLoading(selectedView.customContentPlaceholder, selectedView.customContentPlaceholderAmount) : this.makeLoading() : Items && Items.length > 0 ? this.makeDataList(Items, selectedView) : this.makeNoResults(selectedView.noResultsMessage),
