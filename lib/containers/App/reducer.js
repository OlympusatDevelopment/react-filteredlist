  ...
  switch (action.type) {
    ...
    case _constants.UPDATE_WORKSPACE:
      switch (_data.workspaceAction) {
        ...
        case 'update':
          _state.workspace = {
            checkedItems: _utils.collections.replaceItem(_state.workspace.checkedItems, _data.Item, _state.selectedView.itemIdProp),
        ...
        case 'remove':
          ...
          _state.workspace = {
            checkedItems: _utils.collections.removeItem(_state.workspace.checkedItems, _data.Item, _state.selectedView.itemIdProp),
            action: _data.workspaceAction,
            item: _data.Item
          };
