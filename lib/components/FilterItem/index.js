...
var FilterItem = function (_Component) {
    ...
    _createClass(FilterItem, [{
        ...
        value: function componentWillMount() {
            var self = this;
            this.makeFilter(this.props.options).then(function (FilterComponent) {
                self.setState({ FilterComponent: FilterComponent });
            });
        }
    }, {
            ...
            return new Promise(function (resolve, reject) {
                ...
                switch (self.props.options.type) {
                    ...
                    case 'checkbox':
                        ...
                        resolve(_react2.default.createElement(
                            ...
                            { name: options.id, values: vals, onChange: _this2.handleCheckboxChange.bind(_this2, options) },
                            _react2.default.createElement(
                                'div',
                        ...
                        break;
                    case 'sort':
                        resolve(_react2.default.createElement(_SortItem.SortItem, { options: self.props.options, onClick: _this2.onSortClick }));
                        break;
                    case 'autocomplete':
                        resolve(_react2.default.createElement(_AutoCompleteSelect2.default, _extends({
                    ...
                    default:
                        var val = null;
                        var defaults = self.props.selectedView.filterDefaults ? self.props.selectedView.filterDefaults() : false;
                        try {
                            defaults = JSON.parse(defaults);
                        } catch (e) {}

                        if (!defaults) {
                            options.options.getOptions().then(function (asyncDefaults) {
                ...
                function resume(defaults) {
                    ...
                    if (self.props.options.value) {
                        resolve(_react2.default.createElement(_reactSuperSelect2.default, {
        ...
        value: function makeSelectInitialValue(options, defaults) {
            ...
            var initVals = self.props.options.value.map(function (v) {
                var _ref2;
                ...
                return _ref2 = {}, _defineProperty(_ref2, options.options.key, v), _defineProperty(_ref2, options.options.value, defaultsExtract ? defaultsExtract[options.options.value] : null), _ref2;
            }); // entityValue
