        ...
        default:
          ...
          if (self.props.options.value) {
            ...
            return _react2.default.createElement(_reactSuperSelect2.default, {
              ...
              initialValue: Array.isArray(self.props.options.value) ? self.props.options.value.forEach(function (v) {
                var _ref2;

                return _ref2 = {}, _defineProperty(_ref2, options.options.key, v), _defineProperty(_ref2, options.options.value, v ? v[options.options.value] : null), _ref2;
