  ...
  _createClass(FilterItem, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.options.range) {
        var dateRange = nextProps.options.range;
        if (dateRange.start) {
          this.setState({ startDate: (0, _moment2.default)(dateRange.start * 1) });
        }
        if (dateRange.end) {
          this.setState({ endDate: (0, _moment2.default)(dateRange.end * 1) });
        }
      }
    }
  }, {
    ...
    key: 'onRangeChange',
    value: function onRangeChange(args) {
      var startDate = args.startDate || this.state.startDate;
      var endDate = args.endDate || this.state.endDate;
    ...
    value: function handleRadioChange(options, value) {
      var _props6 = this.props,
          selectedView = _props6.selectedView,
          filterChange = _props6.filterChange;
    ...
    value: function makeFilter(options) {
      var self = this;
      var _opts = options.options ? options.options.getOptions() : [];
      var selectValue = {
        label: 'test',
      ...
      switch (self.props.options.type) {
          ...
          return [_react2.default.createElement(
            ...
            _react2.default.createElement(_reactDatepicker2.default, {
              ...
              onChange: function onChange(startDate) {
                ...
                self.onRangeChange({ startDate: startDate });
              }
            }),
            _react2.default.createElement(
              'div',
              { className: 'dr__divider' },
              _react2.default.createElement(
                'svg',
            ...
            _react2.default.createElement(_reactDatepicker2.default, {
              ...
              onChange: function onChange(endDate) {
                ...
                self.onRangeChange({ endDate: endDate });
              }
            })
          )];
        case 'checkbox':
        ...
        case 'sort':
          ...
          break;
        case 'radio':
          var Radios = _opts.map(function (option) {
            return _react2.default.createElement(
              'label',
              { key: Math.random() * 100 },
              _react2.default.createElement(_reactRadioGroup.Radio, { value: option[options.options.key] }),
              option[options.options.value]
            );
          });
    ...
    value: function makeSelectInitialValue(options, defaults) {
      ...
      var initVals = Array.isArray(self.props.options.value) ? self.props.options.value.map(function (v) {
        ...
        return _ref = {}, _defineProperty(_ref, options.options.key, v), _defineProperty(_ref, options.options.value, defaultsExtract[options.options.value]), _ref;
      } // entityValue
      ) : (_ref2 = {}, _defineProperty(_ref2, options.options.key, self.props.options.value), _defineProperty(_ref2, options.options.value, val ? val[options.options.value] : null), _ref2);
    ...
    value: function render() {
      var _props7 = this.props,
          ...
          config = _props7.config,
          selectedView = _props7.selectedView,
