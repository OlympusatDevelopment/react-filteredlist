...
var TextItem = function (_Component) {
  ...
  _createClass(TextItem, [{
    ...
    key: 'renderHTML',
    value: function renderHTML(html, prop) {
      if (prop.isImage) {
        return _react2.default.createElement('img', { className: 'dl__textItemImage', src: html, alt: prop.label });
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          props.map(function (prop) {
            ...
            var val = item[prop.key];
            var hookedVal = prop.hasOwnProperty('before') ? prop.before(val, item) : val;

            var parsedVal = prop.isDate ? (0, _utils.makeHumanDate)(hookedVal) : _this2.renderHTML(hookedVal, prop);

            var copyIcon = prop.hasCopy ? _react2.default.createElement(
              'span',
              { className: 'dl__textItem-item--copy', onClick: _this2.copyToClipboard.bind(_this2, hookedVal) },
              ' '
            ) : '';
